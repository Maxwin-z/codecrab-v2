...
interface EditAgentDialogProps {
  ...
  onSaved?: (agent: { id: string; name: string; emoji: string }) => void
  onUnauthorized?: () => void
}

export function EditAgentDialog({ open, onOpenChange, agent, onSaved, onUnauthorized }: EditAgentDialogProps) {
